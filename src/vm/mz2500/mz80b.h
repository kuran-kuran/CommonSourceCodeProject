...
#define OPTION_SWITCH_MZ1E18		(1 << 18)
#define OPTION_SWITCH_MZ1R12		(1 << 19)
#define OPTION_SWITCH_MZ1R13		(1 << 20)
#define OPTION_SWITCH_MZ1M01		(1 << 21)
#define OPTION_SWITCH_PIO3034_A0H	(1 << 22)
#define OPTION_SWITCH_PIO3034_A4H	(1 << 23)
#define OPTION_SWITCH_PIO3034_A8H	(1 << 24)
#define OPTION_SWITCH_PIO3034_ACH	(1 << 25)
#define OPTION_SWITCH_MZ2000SD      (1 << 26)
