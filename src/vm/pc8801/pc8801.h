...
#define USE_MIDI
#define USE_CMU800
#define OPTION_SWITCH_DEFAULT	(OPTION_SWITCH_CMU800 | OPTION_SWITCH_HMB20 | OPTION_SWITCH_GSX8800 | OPTION_SWITCH_PCG8100 | OPTION_SWITCH_FDD_5INCH | OPTION_SWITCH_CDROM)
#else
