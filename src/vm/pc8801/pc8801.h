...
#define OPTION_SWITCH_CMU800_MIDI			(1 << 13)
#define OPTION_SWITCH_CMU800_TEMPO_INC_10	(1 << 14)
#define OPTION_SWITCH_CMU800_TEMPO_DEC_10	(1 << 15)
#define OPTION_SWITCH_CMU800_TEMPO_INC_5	(1 << 16)
#define OPTION_SWITCH_CMU800_TEMPO_DEC_5	(1 << 17)
#define OPTION_SWITCH_CMU800_TEMPO_INC_1	(1 << 18)
#define OPTION_SWITCH_CMU800_TEMPO_DEC_1	(1 << 19)
#define OPTION_SWITCH_CMU800_TEMPO_160		(1 << 20)
#define OPTION_SWITCH_CMU800_MELODY_SUSTAIN_INC_1	(1 << 21)
#define OPTION_SWITCH_CMU800_MELODY_SUSTAIN_DEC_1	(1 << 22)
#define OPTION_SWITCH_CMU800_MELODY_DECAY_INC_1		(1 << 23)
#define OPTION_SWITCH_CMU800_MELODY_DECAY_DEC_1		(1 << 24)
#define OPTION_SWITCH_CMU800_BASS_DECAY_INC_1		(1 << 25)
#define OPTION_SWITCH_CMU800_BASS_DECAY_DEC_1		(1 << 26)
#define OPTION_SWITCH_CMU800_CHORD_DECAY_INC_1		(1 << 27)
#define OPTION_SWITCH_CMU800_CHORD_DECAY_DEC_1		(1 << 28)
...
#endif
#define USE_SOUND_VOLUME	(SOUND_VOLUME_OPN1 + SOUND_VOLUME_OPN2 + SOUND_VOLUME_CDROM + SOUND_VOLUME_HMB20 + SOUD_VOLUME_GSX8800 + SOUND_VOLUME_PCG8100 + SOUND_VOLUME_JAST + SOUND_VOLUME_CMU800 + 1 + 1)
#define USE_JOYSTICK
#define USE_MOUSE
#define USE_PRINTER
#if defined(SUPPORT_PC88_JAST)
