...
void MZ1500_SD::write_io8(uint32_t addr, uint32_t data)
{
...
uint32_t MZ1500_SD::read_io8(uint32_t addr)
{
...
bool MZ1500_SD::process_state(FILEIO* state_fio, bool loading)
{
