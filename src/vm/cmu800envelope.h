...
public:
    ...
    // Sustain is used by CMU-800 ch1 only.  It selects the NoteOff release
    // time (not a held level), and is disabled by default so ch2..ch6 retain
    // their original one-shot Decay behavior.
